          ...
          <div className="mb-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input type="text" name="first_name" className="h-9 bg-gray-200" placeholder="Enter your first name" onChange={handleChange} />
                {errors.first_name && <span className="text-red-500 text-sm">{errors.first_name}</span>}
              </div>
              <div>
                <Label htmlFor="middle_name">Middle name</Label>
                <Input type="text" name="middle_name" className="h-9 bg-gray-200" placeholder="Enter your middle name" onChange={handleChange} />
              </div>
              <div>
                <Label htmlFor="last_name">Last name</Label> <span className="text-red-500">*</span>
                <Input type="text" name="last_name" className="h-9 bg-gray-200" placeholder="Enter your last name" onChange={handleChange} />
              ...
              <div>
                ...
                <Input type="text" name="extension_name" className="h-9 bg-gray-200" placeholder="Enter your extension name" onChange={handleChange} />
              </div>
            </div>
          </div>
          ...
          <div className="mb-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input type="email" name="email" className="h-9 bg-gray-200" placeholder="Enter your email" onChange={handleChange} />
                {errors.email && <span className="text-red-500 text-sm">{errors.email}</span>}
              </div>
              <div>
                <Label htmlFor="phone">Mobile number</Label> <span className="text-red-500">*</span>
                <Input type="text" name="phone" className="h-9 bg-gray-200" placeholder="Enter mobile number" onChange={handleChange} />
                {errors.phone && <span className="text-red-500 text-sm">{errors.phone}</span>}
              </div>
              <div>
                <Label htmlFor="gender">Gender</Label> <span className="text-red-500">*</span>
                <Select onValueChange={(value) => setFormData({ ...formData, gender: value })}>
                  <SelectTrigger className="h-9 bg-gray-200">
              ...
              <div>
                ...
                <Input type="text" name="complete_address" className="h-9 bg-gray-200" placeholder="Enter complete address" onChange={handleChange} />
          ...
          <div className="mb-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input type="text" name="acct_number" className="h-9 bg-gray-200" value={accountNumber} readOnly />
              </div>
              <div>
                <Label htmlFor="username">Username</Label> <span className="text-red-500">*</span>
                <Input type="text" name="username" className="h-9 bg-gray-200" placeholder="Enter username" onChange={handleChange} />
              ...
              <div>
                ...
                <div className="relative">
                  <Input
                    ...
                    name="password"
                    className="h-9 bg-gray-200 pr-10"
          ...
          <div className="mb-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input type="text" name="prc_liscence_number" className="h-9 bg-gray-200" placeholder="Enter PRC License No:" onChange={handleChange} />
              </div>
              <div>
              ...
              <div>
                ...
                <Input type="text" name="last_school_att" className="h-9 bg-gray-200" placeholder="Enter Last School or Course attended" onChange={handleChange} />
