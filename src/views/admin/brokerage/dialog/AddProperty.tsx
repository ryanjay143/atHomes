...
import { faPlus, faTimes, faTag, faCalendarAlt, faMapMarkerAlt, faHome, faImages, faDollarSign, faBuilding, faList, faUpload } from "@fortawesome/free-solid-svg-icons";
...
function AddProperty({ onClose, fetchPropertiesData }: AddPropertyProps) {
  ...
  // Consistent image upload logic: accumulate, prevent duplicates, show count in input
              ...
              <div className="grid grid-cols-1 md:grid-cols-1 gap-6">
                ...
                {category === 'Rental Properties' && (
                  <div>
                    ...
                    <Input
                      ...
                      className="rounded-lg border-blue-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 mt-2"
                    />
                    {errors.rentalRate && <p className="text-red-500 text-xs">{errors.rentalRate}</p>}
                  </div>
                )}
                ...
                <div>
                  ...
                  <div className="grid grid-cols-5 md:grid-cols-3 gap-2 mt-4">
                    {imagePreviews.map((preview, index) => (
                      <div
                        key={index}
                        className="relative w-24 h-24 bg-gray-200 flex items-center justify-center rounded-md shadow-md overflow-hidden cursor-pointer group"
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    rows={3}
                  />
                  {errors.otherDetails && <p className="text-red-500 text-xs">{errors.otherDetails}</p>}
                </div>
              </div>
