  ...
  return (
    ...
    <div className='h-full overflow-auto fade-in-left'>
      <Table className='w-full'>
        ...
        <TableBody>
          <TableRow>
            <TableCell className="font-medium border border-[#bfdbfe]">INV002hnyhnyh</TableCell>
            <TableCell className='border border-[#bfdbfe]'>Paid123hnhnh</TableCell>
            <TableCell className='border border-[#bfdbfe]'>Credit Card123hmhmh</TableCell>
