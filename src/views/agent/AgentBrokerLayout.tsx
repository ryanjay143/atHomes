      ...
      <div className="flex min-h-screen">
        ...
        <div className="flex-1 min-h-screen flex flex-col">
          ...
          <div className="sticky top-0 z-30 w-full">
            <div className="ml-80 bg-gradient-to-r from-primary to-blue-900 shadow-lg md:ml-0 flex flex-row rounded-bl-2xl md:rounded-b-[5px] justify-between items-center px-8 py-3 transition-all duration-300">
              <Header />
